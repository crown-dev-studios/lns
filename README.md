...
Apple Silicon macOS and x86_64 Linux receive precompiled Homebrew bottles, so installing LNS does not require Go on those platforms. Homebrew retains a source-build fallback for other platforms.
